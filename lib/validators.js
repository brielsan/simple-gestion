export function validateAuthRequest(data) {
  ...
  if (data.username) {
    if (data.username.length < 3) {
      ...
      errors.username = "The username must not exceed 50 characters";
    }
  }
...
export function validateMovementRequest(data) {
  ...
  if (!data.amount) {
    ...
    errors.amount = "The amount must not exceed 999,999,999.99";
  }
  ...
  if (!data.description) {
    ...
    errors.description = "The description must not exceed 500 characters";
  }
